...
btn_open.place(relx = 0.5, rely = 0.2, anchor = CENTER)

btn_rotate = Button(root, text = "Rotate Image", font = ("Jokerman", 9, "italic"), bg = "lightgrey", fg = "black", relief = "solid", padx =5, pady = 5, command = rotateimage)
btn_rotate.place(relx = 0.5, rely = 0.6, anchor = CENTER)
